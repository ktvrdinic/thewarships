...
public class RPGCamera : MonoBehaviour 
{
    ...
    public Vector3 m_LocalForwardVector;
    float m_Distance;


    public Vector3 direction = Vector3.forward;
    public Vector3 flatDirection = Vector3.forward;
    ...
    void UpdateDistance()
    {
        ...
        if (m_Distance < MinimumDistance) m_Distance = MinimumDistance;
        else if(m_Distance > MaximumDistance) m_Distance = MaximumDistance;
    }
